...
{
    AddFormattedText(ID_txtVersion, DrawPoint(0, 600), "%1% - %2%", COLOR_YELLOW, FontStyle::LEFT | FontStyle::BOTTOM,
                     NormalFont)
      % rttr::version::GetEditionName() % rttr::version::GetReadableVersion();
